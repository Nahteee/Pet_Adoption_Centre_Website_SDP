...
<html>
    ...
    <center>
        ...
        <br>
        Upload Image:
        <input type="file" name="image" accept="uploads/*" onchange="preview_image(event)">
        <br><br>
    ...
    if(isset($_POST['submit'])){
        ...
        if($t_name && $content){
            if(strlen($t_name) >= 10 && strlen($t_name) <= 70){
                ...
                $sql="INSERT INTO topics (topic_name, topic_content, topic_creator,topic_creator_id,image) 
                    VALUES ('$t_name','$content','$post_user','".$_SESSION['auth_user_id']."', '$file_name')";
