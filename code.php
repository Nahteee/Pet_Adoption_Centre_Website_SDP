...
if(isset($_POST['add_sub_replies']))
{
    ...
    $query = "INSERT INTO comment_replies(comment_id,reply_msg,user_id,topic_id) VALUES ('$cmt_id','$reply_msg','$user_id',$topic_id)";
...
if(isset($_POST['add_reply']))
{
    ...
    $queryy = "INSERT INTO comment_replies(comment_id,reply_msg,user_id,topic_id) VALUES('$cmt_id','$reply','$user_id','$topic_id')";
...
if(isset($_POST['comment_load_data']))
    {
        ...
        $topicid = $_POST['t_id'];
        $comments_query = "SELECT * FROM topics INNER JOIN comments ON topics.topic_id = comments.topic_id WHERE topics.topic_id = $topicid";
...
if(isset($_POST['add_comment']))
    ...
    else
    {
        ...
        $comment_add_query = "INSERT INTO comments (user_id,msg,topic_id ) VALUES ('$user_id','$msg','$topic_id')";
